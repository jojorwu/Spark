...
#[no_mangle]
pub extern "C" fn spark_node_set_position(_scene_ptr: *mut Scene, node_id: u32, x: f32, y: f32, z: f32) {
    ...
    log::info!("C# calling spark_node_set_position: node={}, pos=({}, {}, {})", node_id, x, y, z);
}
